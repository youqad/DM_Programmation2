...
let tests1 = [
  ...
  Seq( Rep (Seq (Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Sym 'b')), Seq(Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Rep (Seq (Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Sym 'b')))), ['b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'b'; 'a'; 'b'; 'a'; 'c'; 'b'; 'a'; 'a'; 'c'; 'b'; 'b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'c'; 'b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'b'; 'a'; 'b'; 'a'; 'c'; 'b'; 'a'; 'a'; 'c'; 'b'], true;
  Alt(Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Seq(Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Rep (Seq (Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Sym 'b')))), ['b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'c'; 'b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'b'; 'a'; 'b'; 'a'; 'c'; 'b'; 'a'; 'a'; 'c'; 'b'], true;
  Alt(Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Seq(Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Rep (Seq (Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Sym 'b')))), ['b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'c'; 'b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'b'; 'a'; 'b'; 'a'; 'c'; 'b'; 'a'; 'a'; 'c'; 'b'; 'b'; 'c'], false;
  Seq(Seq( Rep (Seq (Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Sym 'b')), Seq(Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Rep (Seq (Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Sym 'b')))), Seq( Rep (Seq (Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Sym 'b')), Seq(Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Rep (Seq (Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Sym 'b'))))), ['b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'b'; 'a'; 'b'; 'a'; 'c'; 'b'; 'a'; 'a'; 'c'; 'b'; 'b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'c'; 'b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'b'; 'a'; 'b'; 'a'; 'c'; 'b'; 'a'; 'a'; 'c'; 'b'; 'b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'b'; 'a'; 'b'; 'a'; 'c'; 'b'; 'a'; 'a'; 'c'; 'b'; 'b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'c'; 'b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'b'; 'a'; 'b'; 'a'; 'c'; 'b'; 'a'; 'a'; 'c'; 'b'], true;
    Alt(Alt(Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Seq(Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Rep (Seq (Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Sym 'b')))), Seq(Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Rep (Seq (Rep (Seq(Alt (Seq (Sym 'a', Rep (Sym 'b')), Rep (Seq (Alt (Sym 'a', Sym 'b'), Sym 'a')) ), Sym 'c')), Sym 'b')))), ['b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'c'; 'b'; 'a'; 'b'; 'a'; 'a'; 'a'; 'a'; 'a'; 'c'; 'a'; 'a'; 'b'; 'a'; 'b'; 'a'; 'c'; 'b'; 'a'; 'a'; 'c'; 'b'], true;
